...
| ------------------------ | --------------- | --------------------------------------------------------- |
| React + TypeScript       | UI и типизация  | Обязательное требование ТЗ                                |
| Vite                     | Сборщик         | Современный стандарт, быстрый HMR                         |
| React Bootstrap          | UI-компоненты   | Обязательное требование ТЗ                                |
| TanStack Query           | Серверный стейт | Кеширование, состояния загрузки, автоматический рефетч    |
| Axios                    | HTTP-клиент     | Удобные интерсепторы, типизированные ответы               |
| React Router             | Навигация       | Стандарт для SPA, URL-навигация между экранами            |
| React Toastify           | Уведомления     | Готовые toast-уведомления с анимацией                     |
| Vitest + Testing Library | Тесты           | Указан в требованиях вакансии, нативная интеграция с Vite |

Zustand установлен, но не используется — серверный стейт полностью покрывается TanStack Query, клиентского стейта в приложении недостаточно для отдельного стор-менеджера.
