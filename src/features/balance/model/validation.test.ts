...
describe("getValidationError", () => {
  ...
  it("возвращает ошибку если сумма превышает максимум", () => {
    expect(getValidationError("100001")).toBe(
      "Максимальная сумма — 100\u00A0000"
    );
  });

  it("пропускает сумму равную максимуму", () => {
    expect(getValidationError("100000")).toBeNull();
  });
